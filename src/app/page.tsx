...
export default function Home() {
  ...
  // Általános AI hívás (szöveges típusokhoz)
  ...
  // Hangfájl feltöltés és transzkripció
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // 1. Lépés: Szöveggé alakítás (Whisper)
      ...
      // 2. Lépés: Összefoglaló generálása a már meglévő chat API-val
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-8 flex flex-col min-h-0">
        ...
        <Tabs defaultValue="faq" className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-1 min-h-0">
            ...
            {/* Well-being Szekció - Marad a régi */}
